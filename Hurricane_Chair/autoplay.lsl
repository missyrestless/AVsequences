...
// string COUPLES_POSE_F = "SEQ_F_CUDDLE";
string COUPLES_POSE_F = "SEQ_F_KING";
// Singles Female Sequence
string SINGLES_POSE_F = "SEQ_F_QUEEN";
// Couples Male Sequence
// string COUPLES_POSE_M = "SEQ_M_CUDDLE";
string COUPLES_POSE_M = "SEQ_M_QUEEN";
// Singles Male Sequence
string SINGLES_POSE_M = "SEQ_M_KING";
