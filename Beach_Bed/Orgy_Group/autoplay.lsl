...
string COUPLES_POSE_F = "SEQ_MFCUDDLE*";
// Singles Female Sequence
string SINGLES_POSE_F = "SEQ_SINGLE*";
// Couples Male Sequence
string COUPLES_POSE_M = "SEQ_MFCUDDLE*";
// Singles Male Sequence
string SINGLES_POSE_M = "SEQ_SINGLE*";
// 3 Sitter Sequence
string TRIPLES_POSE_F = "SEQ_FFMCUDDLE*";
string TRIPLES_POSE_M = "SEQ_MMFCUDDLE*";
// 4 Sitter Sequence
string FOURTHS_POSE_F = "SEQ_4CUDDLE*";
string FOURTHS_POSE_M = "SEQ_4CUDDLE*";
