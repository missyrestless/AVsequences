...
string COUPLES_POSE_F = "SEQCuddles";
// Singles Female Sequence
string SINGLES_POSE_F = "SEQSheSits";
// Couples Male Sequence
string COUPLES_POSE_M = "SEQCuddles";
// Singles Male Sequence
string SINGLES_POSE_M = "SEQHeSits";
// 3 Sitter Sequence
string FMF_POSE = "SEQfmf";
    ...
    changed(integer change) {
	    ...
	    // Use female poses for ambiguous or undefined gender
            ...
            if (avatar_count>2) { // more than two avatars sitting
                llMessageLinked(LINK_SET,90000,FMF_POSE,""); // play singles pose
