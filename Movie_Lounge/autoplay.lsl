...
string COUPLES_POSE_F = "SEQ-2-CUDDLE";
// Singles Female Sequence
string SINGLES_POSE_F = "SEQ-1-SOLO";
// Couples Male Sequence
string COUPLES_POSE_M = "SEQ-2-CUDDLE";
// Singles Male Sequence
string SINGLES_POSE_M = "SEQ-1-SOLO";
// 3 Sitter Sequence
string TRIPLES_POSE_F = "SEQ-3-FFMCUDD";
string TRIPLES_POSE_M = "SEQ-3-FMMCUDD";
    ...
    changed(integer change) {
        if (change & CHANGED_LINK) {
            ...
            if (avatar_count > 0) { // at least one avatar is seated
              ...
              if (avatar_count > 5) { // more than five avatars sitting
                llMessageLinked(LINK_SET,90000,"SEQ-6-SOLO","");
              } else if (avatar_count > 4) {
                llMessageLinked(LINK_SET,90000,"SEQ-5-SOLO","");
              } else if (avatar_count > 3) {
                llMessageLinked(LINK_SET,90000,"SEQ-4-SOLO","");
              } else if (avatar_count > 2) { // more than three avatars sitting
