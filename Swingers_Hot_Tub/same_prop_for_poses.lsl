/******************************************************************
* Requires [AV]prop script from box 2.1-07 or later! ( see https://avsitter.com/updates )
* 
...
* PROP Rezz Float|float|G2|<0.504880, 0.470310, 0.363890>|<180.000000, 0.000000, -135.000000>
******************************************************************/

string prop_trigger = "Rezz Float";
list poses = ["Sleepy Time", "Spooning", "On Her Back", "Love Her", "Gentle Love", "Tastes Good", "Wet Hump", "Les Licks", "Tasty Ass", "Cunny Rubs", "AllGirl 69", "Fist In Her", "InvertLick", "Yoga Lick"];
integer SITTER = -1;
